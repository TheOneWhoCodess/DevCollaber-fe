        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="liquid-glass rounded-[24px] p-5">
                ...
                <div className="flex gap-6">
                    <div>
                        <p className="font-grotesk text-[22px] text-cream">{data.contributions}</p>
                        <p className="font-mono text-[10px] uppercase text-cream/30">contributions</p>
                    </div>
                    <div>
                        <p className="font-grotesk text-[22px] text-cream">{data.repos.length}</p>
                        <p className="font-mono text-[10px] uppercase text-cream/30">repos</p>
                    </div>
                    <div>
                        <p className="font-grotesk text-[22px] text-cream">{data.followers}</p>
